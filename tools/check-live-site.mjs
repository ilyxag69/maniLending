...
check("home page loads", async () => {
  ...
  assert(body.includes("script.js?v=20260705-testdrive-1"), "Expected script cache-bust is missing");
  assert(body.includes("newmani.css?v=20260705-testdrive-1"), "Expected CSS cache-bust is missing");
