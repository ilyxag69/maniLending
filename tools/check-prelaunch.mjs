...
try {
  ...
  check(html.includes("Mani.ai — деньги под контролем"), "SEO positioning is explicit");
  check(html.includes("https://moimani.ai/og-image-v3.jpg"), "current OG image is explicit");
